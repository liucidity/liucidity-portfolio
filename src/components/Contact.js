...
const Contact = () => {
  return (
    <section className='mt-96 md:mt-0 flex flex-col justify-center items-center h-screen' id='contact'>
      ...
      <p className='text-light-purple md:text-xl md: w-[24em] text-center p-2'>I'm always interested in discussing all things tech! My inbox is always open. Whether you have any questions, or looking for a quick coffee chat, I'll try my best to get back to you!</p>
