      ...
      <div className='md:flex flex-col items-center relative md:right-[15em] p-4'>
        ...
        <div className='flex flex-col'>
          ...
          <h2 className='text-light-purple text-4xl relative'>
            ...
            <span className='h-0.5 w-full md:w-72 bg-light-purple opacity-25 relative block md: md:top-[-0.5em] md:left-[10em]'></span>
          </h2>
        </div>
      </div>
      <div>
