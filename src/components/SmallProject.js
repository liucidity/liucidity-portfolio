...
const SmallProject = ({ project, description, technologies, github, demo }) => {
  return (
    <div className='group bg-ming m-auto md:m-2 mt-2 mb-2 p-4 h-[22em] md:w-[24em] md:w-[22em] relative transition ease-in-out delay-150 md:hover:-translate-y-1 md:hover:scale-110 duration-300 hover:text-green rounded-lg'>
